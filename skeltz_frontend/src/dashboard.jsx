      ...
      <body>
        <div className="my-4 flex flex-1 flex-row justify-evenly border-4 border-transparent">
          ...
          <div
            ...
            className="absolute inset-y-xl md:-left-20 transform md:relative opacity-0 md:opacity-100  md:translate-x-0 -translate-x-full transition duration-200 ease-in-out"
          >
